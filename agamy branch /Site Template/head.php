...
<div class="search-area">
    <form method="get">
        <div class="control-group">
            <input class="search-field" id="searchBar" name="user_query" placeholder="Search for item" />
            ...
            <ul class="categories-filter animate-dropdown">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" role="menu" id="drop">
                        ...
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.php?searchAll=<?php if(isset($_GET['user_query']))  {echo $_GET['user_query'];  }  ?>">All </a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.php?searchPrice=<?php if(isset($_GET['user_query'])) { echo $_GET['user_query']; }  ?>">Price </a></li>
                        <li role="presentation"><a role="menuitem" tabindex="-1" href="category-grid.php?searchProduct=<?php if(isset($_GET['user_query'])) {echo $_GET['user_query']; }  ?>">Product </a></li>
